...
TEST(MultTest, MultEvaluateDecimal) { //Mult .5
    ...
    Mult* test = new Mult(num1, num2);
    EXPECT_DOUBLE_EQ(test->stringify(), 4.0);
}
...
TEST(AddTest, AddEvaluatePositive) {  //add + stringify	
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(4.0);
	
    Add* test = new Add(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), "(8.0+4.0)");
}

TEST(AddTest, OpEvaluateNegative) { //add - stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(-4.0);
    Add* test = new Add(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), "(8.0+-4.0)");
...
TEST(SubTest, SubEvaluatePositive) { //sub + stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(4.0);
    Sub* test = new Sub(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), "(8.0-4.0)");
...
TEST(SubTest, SUbEvaluateNegative) { //sub - stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(-3.0);
	
    Sub* test = new Sub(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), "(8.0--3.0)");
}

TEST(MultTest, MultEvaluatePositive) { //Mult + stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(3.0);
...
TEST(MultTest, MultEvaluateDecimal) { //Mult .5 stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(0.5);
...
TEST(DivTest, DivEvaluateNegative) { //Div - stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(-2.0);
    Div* test = new Div(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), -4.0);
}
TEST(DivTest, DivEvaluateDecimal) { //Div .5 stringify
	Base* num1 = new Op(8.0);
	Base* num2 = new Op(0.5);
    Div* test = new Div(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), 16.0);
}
TEST(PowTest, PowEvaluatePostive) { //Pow + stringify
	Base* num1 = new Op(4.0);
	Base* num2 = new Op(3.0);
    Pow* test = new Pow(num1, num2);
    EXPECT_DOUBLE_EQ(test->evaluate(), 64.0);
...
TEST(RandTest, RandEvaluateNonZero) { //stringify
	Rand* test = new Rand();
	EXPECT_TRUE( (test->evaluate() >= 0) && (test->evaluate() <= 100));
}
